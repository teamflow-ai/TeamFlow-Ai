...
public final class MessagingConstants {
    ...
    public static final String PROJECT_MEMBER_REMOVED = "project.member_removed";
    ...
    // ---- routing keys : approval workflow engine ----
    ...
    public static final String APPROVAL_RETURNED = "approval.returned";
    ...
    public static final String QUEUE_AI_APPROVAL_EVENTS = "ai.approval.events";
