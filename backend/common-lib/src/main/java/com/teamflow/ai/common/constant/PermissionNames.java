...
public final class PermissionNames {
    ...
    public static final String APPROVE_MILESTONE = "APPROVE_MILESTONE";
    public static final String APPROVE_TASK_COMPLETION = "APPROVE_TASK_COMPLETION";
    public static final String REQUEST_PROJECT_CLOSURE = "REQUEST_PROJECT_CLOSURE";
    public static final String APPROVE_PROJECT_CLOSURE = "APPROVE_PROJECT_CLOSURE";
    public static final String MANAGE_CLIENT_APPROVAL = "MANAGE_CLIENT_APPROVAL";
