...
public class OpenApiConfig {
    ...
    public OpenAPI aiServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("TeamFlow.AI — Intelligent Workload Management Service")
                        .description("""
                                Smart task-assignment recommendations, workload scoring, manager alerts, \
                                dashboards, and in-app notifications.
